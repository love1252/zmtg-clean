...
- 当前重构分支：`docs/restructure-roadmap-17-31-20260726-161932`
- 重构基线：`f5802888ec70c1fc02e21b2938de0d740411c933`
- 当前阶段：第十七阶段，交接更新与第十七至第三十一阶段路线图固化
- 下一阶段：第十八阶段，API 调用方与兼容策略基线
- 架构形态：模块化单体
- 数据库迁移目录：`drizzle/`
