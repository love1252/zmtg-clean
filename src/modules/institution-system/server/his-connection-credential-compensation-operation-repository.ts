...
import type { HisConnectionCredentialCompensationOperationRepository as HisConnectionCredentialCompensationOperationRepositoryPort } from '@/modules/institution-system/application/his-connection-credential-compensation-ports';
...
export function createHisConnectionCredentialCompensationOperationRepository(
  database: TenantDatabase,
): HisConnectionCredentialCompensationOperationRepositoryPort {
  return {
