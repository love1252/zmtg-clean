...
const controlledTrialReadiness: KnowledgeBaseControlledTrialReadiness = {
  ...
  blockedCapabilities: [
    ...
    { id: 'scannedPdf', label: '扫描 PDF', description: '扫描件没有可抽取文本时会安全失败。' },
    { id: 'realAi', label: '真实 AI', description: '真实 AI 未启用，QA 仍为 mock/local。' },
    { id: 'vectorStore', label: '真实向量库', description: '当前仅使用本地 mock embedding。' },
    { id: 'runtimeIngestion', label: 'runtime ingestion', description: '不启用自动 ingestion 链路。' },
    { id: 'workerQueue', label: 'worker/queue', description: '不启用后台 worker 或 queue。' },
    { id: 'training', label: '训练', description: '不做模型训练或知识训练系统。' },
    { id: 'billing', label: '计费', description: '不接入计费或商业化扣费。' },
    { id: 'dashboard', label: 'dashboard', description: '不新增 dashboard 聚合页。' },
  ],
