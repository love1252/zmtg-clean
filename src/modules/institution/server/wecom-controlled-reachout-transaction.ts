...
import { runWeComReachOutTransaction } from '@/server/orchestration/wecom-reachout-transaction';
...
export async function runWeComControlledReachOutTransaction<T>(
  ...
  return runWeComReachOutTransaction(database, (dependencies) => operation({
