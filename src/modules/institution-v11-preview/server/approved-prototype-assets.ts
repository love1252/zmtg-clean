...
const knowledgeTableCard=()=>[...document.querySelectorAll('#page .table-card')].find(card=>{const headers=[...card.querySelectorAll('thead th')].map(textOf);return headers[0]==='标题'&&headers.includes('版本')&&headers.includes('状态')});
