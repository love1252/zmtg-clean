...
declare const institutionConversationReadAuthorizationMarkerV1: unique symbol;

export type InstitutionConversationReadAuthorizationHandleV1 = Readonly<{
  readonly [institutionConversationReadAuthorizationMarkerV1]:
    'institution_conversation_read_authorization_v1';
}>;
...
export type InstitutionConversationReadAuthorizationResolutionV1 =
  | Readonly<{
      kind: 'allowed';
      authorization: InstitutionConversationReadAuthorizationHandleV1;
    }>
...
const consumptions = new WeakMap<
  object,
  InstitutionConversationReadAuthorizationConsumptionV1
>();
...
export function isInstitutionConversationReadAuthorizationHandleV1(
  value: unknown,
): value is InstitutionConversationReadAuthorizationHandleV1 {
  try {
    return (
      value !== null &&
      typeof value === 'object' &&
...
export function consumeInstitutionConversationReadAuthorizationV1(
  value: unknown,
): InstitutionConversationReadAuthorizationConsumptionV1 | null {
  if (!isInstitutionConversationReadAuthorizationHandleV1(value)) return null;
...
export async function resolveInstitutionConversationReadAuthorizationV1(): Promise<InstitutionConversationReadAuthorizationResolutionV1> {
  try {
    ...
    }) satisfies InstitutionConversationReadAuthorizationConsumptionV1;
    const authorization = Object.freeze(
      {},
    ) as InstitutionConversationReadAuthorizationHandleV1;
