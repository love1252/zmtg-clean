...
const ROUTE_PATH = 'src/app/api/institution/entitlement-usage/route.ts';

describe('BASE-B4-ROUTE-01 first-batch Route Guard wiring', () => {
  it('uses only the frozen system Section Guard boundary', async () => {
