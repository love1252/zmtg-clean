...
const ROUTE_PATH = 'src/app/api/institution/knowledge-management/qa/audits/route.ts';

describe('BASE-B4-ROUTE-SECOND-04 Route Guard wiring', () => {
  it('uses the frozen knowledge Section Guard and preserves the existing handler boundary', async () => {
