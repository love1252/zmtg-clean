...
const ROUTE_PATH = 'src/app/api/institution/wecom/customer-mapping-candidates/route.ts';

describe('BASE-B4-ROUTE-THIRD-04 Route Guard wiring', () => {
  it('uses the frozen conversations Section Guard and preserves the existing handler boundary', async () => {
    ...
    expect(source).toContain("sectionId: 'conversations'");
