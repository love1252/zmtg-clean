...
CREATE UNIQUE INDEX "knowledge_sources_tenant_id_id_unique" ON "knowledge_sources" USING btree ("tenant_id","id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "knowledge_documents_tenant_id_id_unique" ON "knowledge_documents" USING btree ("tenant_id","id");--> statement-breakpoint
